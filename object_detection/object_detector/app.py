...
from utils.app_utils import HLSVideoStream, WebcamVideoStream, draw_boxes_and_labels
from object_detection.utils import label_map_util

CWD_PATH = os.getcwd()
#
# Path to frozen detection graph. This is the actual model that is used for the object detection.
# MODEL_NAME = 'faster_rcnn_resnet_v1_coco'
...
def detect_objects(image_np, sess, detection_graph):
    ...
    # The tensor is the input to the model
...
def worker(input_q, output_q):
    ...
    with detection_graph.as_default():
        # Loading the frozen TF model from the provided checkpoint
    ...
    while True:
        ...
        # Convert it to RGB
        # And put the detection on a separate thread for some speed gain
        frame = input_q.get()
